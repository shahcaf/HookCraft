      ...
      <div className="container max-w-4xl px-4 py-24 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-24">
          ...
          <div className="p-8 rounded-3xl bg-card border border-border/50 shadow-2xl relative overflow-hidden group">
            ...
            <p className="text-muted-foreground leading-relaxed">
              HookCraft is built with love and open technologies. We believe in transparency and community contributions. Join our server to provide feedback and shape the future of the platform!
            </p>
          </div>
        </div>
        ...
        <div className="text-center bg-muted/30 rounded-3xl p-12 border border-border/50">
          ...
          <Link href="https://discord.gg/PqdZAgzjTs" target="_blank" className="inline-flex items-center justify-center gap-2 bg-[#5865f2] hover:bg-[#4752c4] text-white px-8 py-4 rounded-xl font-bold transition-all transform hover:scale-105 active:scale-95 shadow-lg shadow-[#5865f2]/25">
